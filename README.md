...
/*# sourceMappingURL=bootstrap.min.css.map */
    ...
    src: url("../fonts/materialdesignicons-webfontd41d.eot?#iefix&v=5.8.55")
      ...
      url("../fonts/materialdesignicons-webfonte910.html?v=5.8.55")
        format("woff2"),
      url("../fonts/materialdesignicons-webfonte910.woff?v=5.8.55") format("woff"),
      url("../fonts/materialdesignicons-webfonte910-2.html?v=5.8.55")
        format("truetype");
    font-weight: normal;
    font-style: normal;
  }
...
.swiper-slider-hero .swiper-container .swiper-button-next:hover,
.ribbon.ribbon-primary span {
  background-color: #36345c!important;
}
...
.ribbon.ribbon-primary span:after {
  ...
  border-top-color: #6e00ff;
        ...
        <!--<link rel="stylesheet" href="line26.css">
        <link href="line27.css" rel="stylesheet" type="text/css" />
        <link href="line28.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css')}}" />
    
        
        <link rel="stylesheet" href="line32.css" />
        <link rel="stylesheet" href="line33.css" />
        <!-- Main Css -
        <link href="line35.css" rel="stylesheet" type="text/css" />
...
_smartsupp.key = 'ab99eb825a169b4b0dc2963b8b4826b646bf6f24';
...
c.src='https://www.smartsuppchat.com/loader.js?';s.parentNode.insertBefore(c,s);
        ...
        <div class="container">
          ...
          <!--  <div>
            ...
            <div class="buy-button">
                ...
                <a href="../Create/register.html" class="btn btn-primary login-btn-success ">Get Started</a>
            ...
            <div class="row align-items-center">
                ...
                <div class="pt-2 mt-4 col-lg-6 col-md-5 mt-sm-0 pt-sm-0">
                    <div class="position-relative">
                        <img src="https://gatewaycapitalltd.com/storage/app/public/photos/pRDMWKVxu1jH74ggKveNtOK01aU7NObSA0YPhmO4.png" class="mx-auto roundedd img-fluid d-block"
                            alt="">
                    </div>
                </div>
                <!--end col-->
            ...
            <div class="row">
                    ...
                    <div class="text-center border-0 rounded card">
                        <div class="card-body">
                            <div class="p-3 shadow bg-soft-primary roundedd d-inline-block">
                                <img src="https://gatewaycapitalltd.com/temp/images/icon/key.svg" class="avatar avatar-small"
                                    alt="">
                            </div>
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)" class="text-dark">Security</a></h5>
                                <p class="mt-3 mb-0 text-muted">SAXO investments uses the highest levels of Internet Security, and it is secured by 256 bits SSL security encryption to ensure that your information is completely protected from fraud.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-2 mt-4 col-md-6 col-12">
                    <div class="text-center border-0 rounded card">
                        <div class="card-body">
                            <div class="p-3 shadow bg-soft-primary roundedd d-inline-block">
                                <img src="https://gatewaycapitalltd.com/temp/images/icon/locked.svg" class="avatar avatar-small"
                                    alt="">
                            </div>
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)" class="text-dark">Two Factor Auth</a></h5>
                                <p class="mt-3 mb-0 text-muted">Two-factor authentication (2FA) by default on all SAXO investments accounts, to securely protect you from unauthorised access and impersonation.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="text-center col-lg-7 col-md-7">
                    <div class="pb-2 mb-4 section-title">
                        ...
                        <p class="mx-auto mb-0 text-muted para-desc">It’s our mission to provide you with a delightful and a successful trading experience!</p>
                    </div>
                </div>
                <!--end col-->
            ...
            <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para">We are outstanding when it comes to managing risk in order to capitalize on opportunities and improve our performance.</p>
                                </div>
                            </div>
                        </div>
                        <!--end col-->
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para">Chance to magnify your investment and really win big with super-low spreads to further up your profits</p>
                                </div>
                            </div>
                        </div>
                        <!--end col-->
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para">Super-fast trading software, so you never suffer slippage.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para">Strict measures has been put in place to ensure that clients&#039; funds, assets and information are completely safe and fully secured.</p>
                                </div>
                            </div>
                        </div>
                        <!--end col-->
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para">We have a dedicated team of support staff who are always online and available to answer to your requests and attend to all your issues.</p>
                                </div>
                            </div>
                        </div>
                        <!--end col-->
                ...
                <div class="pt-2 mt-4 text-center col-lg-4 col-md-4 col-12 text-md-right">
                    <img src="https://gatewaycapitalltd.com/temp/images/app/phone.png" class="img-fluid" alt="">
                </div>
                <!--end col-->
            </div>
            <!--end row-->
    ...
    <section class="overflow-hidden section bg-soft-primary">
        <div class="container mt-100 mt-60 ">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <img src="https://gatewaycapitalltd.com/temp/images/app/laptop.png" class="img-fluid " alt="">
                </div>
                <!--end col-->

                <div class="pt-2 mt-4 col-lg-6 col-md-6 mt-sm-0 pt-sm-0">
                    <div class="section-title ml-lg-5">
                        <h4 class="mb-4 title">Our White Paper
                        </h4>
                        <p class="text-muted">SAXO investments is fully Licensed and registered</p>

                        <a href="https://gatewaycapitalltd.com/temp/pdf/companies_house_document .pdf" class="mt-3 h6 text-primary">Find Out More <i
        ...
        <div class="container mt-100 mt-60 ">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <img src="https://gatewaycapitalltd.com/temp/images/app/invest-logos.png" class="img-fluid " alt="">
                </div>
                <!--end col-->

                <div class="pt-2 mt-4 col-lg-6 col-md-6 mt-sm-0 pt-sm-0">
                    <div class="section-title ml-lg-5">
                        <h4 class="mb-4 title">Stake on Big brands
                        </h4>
                        <p class="text-muted">Invest in the biggest brands all over the globe, get a share of your favorite company by tradind and investing with us</p>
            ...
            <div class="row">
                        ...
                        <div class="p-4 border-0 rounded-md shadow card pricing-rates business-rate">
                            <div class="p-0 card-body">
                                <span
                                    class="px-4 py-2 mb-0 rounded-lg d-inline-block bg-soft-primary h6 text-primary">Starter (3.5% Daily for 7days)</span>
                                <h2 class="mt-3 mb-0 font-weight-bold">$ 200
                                </h2>
                                ...
                                <ul class="pt-3 list-unstyled border-top">
                                    ...
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i></span>10
                                        Referral Bonus</li>
                                </ul>
                    ...
                    <!--end col-->
                        ...
                        <div class="p-4 border-0 rounded-md shadow card pricing-rates business-rate">
                            <div class="p-0 card-body">
                                <span
                                    class="px-4 py-2 mb-0 rounded-lg d-inline-block bg-soft-primary h6 text-primary">Premium plan (4.5% Daily for 7days)</span>
                                <h2 class="mt-3 mb-0 font-weight-bold">$ 6000
                                </h2>
                                <p class="text-muted">7 Days</p>
                    ...
                    <!--end col-->
                        ...
                        <div class="p-4 border-0 rounded-md shadow card pricing-rates business-rate">
                            <div class="p-0 card-body">
                                <span
                                    class="px-4 py-2 mb-0 rounded-lg d-inline-block bg-soft-primary h6 text-primary">Standard plan (5.5% Daily for 7days)</span>
                    ...
                    <!--end col-->
                        ...
                        <div class="p-4 border-0 rounded-md shadow card pricing-rates business-rate">
                            <div class="p-0 card-body">
                                <span
                                    class="px-4 py-2 mb-0 rounded-lg d-inline-block bg-soft-primary h6 text-primary">Compounding plan (5.5% Daily for 30days)</span>
                                <h2 class="mt-3 mb-0 font-weight-bold">$ 40000
                                </h2>
                    ...
                    <!--end col-->
                        ...
                        <div class="p-4 border-0 rounded-md shadow card pricing-rates business-rate">
                            <div class="p-0 card-body">
                                <span
                                    class="px-4 py-2 mb-0 rounded-lg d-inline-block bg-soft-primary h6 text-primary">Regional Representative Bonus</span>
                                <h2 class="mt-3 mb-0 font-weight-bold">$20000
                                </h2>
                                <p class="text-muted">1 Months</p>
                                ...
                                <ul class="pt-3 list-unstyled border-top">
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i>100 active downlines</li>
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i></span>Generate $250,000 in all</li>
                                   
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i></span>Weekly salary = $2,500</li>
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i></span>15% referral bonus</li>
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i></span>Loan availability</li>
                                    <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                                class="align-middle uil uil-check-circle"></i></span>A Luxury trip for two to Seychelles for a week</li>            
                                </ul>
...
<div class="tradingview-widget-container">
  ...
  "valuesTracking": "1",
  "chartType": "line",
  "container_id": "tradingview_2f043"
}
  );
  </script>
</div>
...
<div class="tradingview-widget-container">
  ...
  <script type="text/javascript" src="line676.js" async>
  {
  "width": "100%",
  "height": 523,
...
<!-- TradingView Widget END -->
                    ...
                    <div id="single-owl" class="owl-carousel owl-theme">
                            ...
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-md-7">
                                    <div class="card-body customer-testi">
                                        <h6 class="text-primary font-weight-bold">Arnold<small
                                                class="text-muted d-block">Investor</small></h6>
                                        ...
                                        <p class="mb-0 text-muted h6 font-italic">"Was a hard decision to begin at first now it’s a much harder decision to stop"</p>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                        ...
                        <div class="m-2 overflow-hidden border-0 card roundedd">
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-md-7">
                                    <div class="card-body customer-testi">
                                        <h6 class="text-primary font-weight-bold">Matt strider<small
                                                class="text-muted d-block">Investor</small></h6>
                                        <ul class="mb-0 list-unstyled">
                                            <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i>
                                            </li>
                                        ...
                                        <p class="mb-0 text-muted h6 font-italic">"I am happy to have made the decision to join this platform"</p>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-md-8">
                        <div class="text-center section-title text-md-left">
                            <h4 class="mb-3 text-white title title-dark">Research and Insight</h4>
                            <p class="mb-0 text-white">The New Investment Paradigm The COVID-19 pandemic accelerated the shift to a new investment paradigm, characterized by near-zero interest rates, coordinated monetary and fiscal policy, and heightened internal and external conflict. While the pandemic was an accelerant, we believe this shift was inevitable and that the key elements of this new environment will remain long after the virus passes.</p>
                        </div>
                    </div>
                    <!--end col-->
                    ...
                    <div class="mt-4 col-md-4 mt-sm-0">
                        <div class="text-center text-md-right">
                            <a href="../Create/register.html" class="pt-3 pb-3 pl-4 pr-4 btn btn-light">Create Free
                                Account</a>
                        </div>
                    </div>
                    <!--end col-->
        ...
        <div class="container">
            <div class="row">
                <div class="pb-0 mb-0 col-lg-4 col-12 mb-md-4 pb-md-2">
                    <h5 class="text-light footer-head">SAXO investments.</h5>
                ...
                <div class="pt-2 mt-4 col-lg-4 col-md-4 mt-sm-0 pt-sm-0">
                    ...
                    <ul class="mt-4 list-unstyled footer-list">
                        <li><a href="https://gatewaycapitalltd.com" class="text-foot"><i class="mr-1 mdi mdi-chevron-right"></i>
                                Home</a></li>
                        <li><a href="https://gatewaycapitalltd.com/about" class="text-foot"><i class="mr-1 mdi mdi-chevron-right"></i>
                                About us</a></li>
                        <li><a href="https://gatewaycapitalltd.com/contact" class="text-foot"><i class="mr-1 mdi mdi-chevron-right"></i>
                                Contact Us</a></li>
                        <li><a href="https://gatewaycapitalltd.com/faq" class="text-foot"><i class="mr-1 mdi mdi-chevron-right"></i>
                                Faq</a></li>
                    </ul>
                </div>
                <!--end col-->
                ...
                <div class="pt-2 mt-4 col-lg-4 col-md-4 mt-sm-0 pt-sm-0">
                    ...
                    <div class="mt-2">
                        <h6 class="text-foot"><i class="mr-1 mdi mdi-home"> </i>
                            Head Office</h6>
                        <p>PO BOX 648, SAXO House Tollgate, Chandlers Ford, Eastleigh, Hampshire, United Kingdom, SO50 0ND</p>
                        <h6><i class="mr-1 mdi mdi-email"> </i>Email Address</h6>
                        <p>support@gatewaycapitalltd.com</p>
                    </div>
                </div>
                <!--end col-->
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="text-sm-left">
                        <p class="mb-0">
                            © Copyright 2023 SAXO investments. All
                            Rights Reserved.
                        </p>
                    </div>
                </div>
    ...
    <!-- Footer End -->
                  ...
                  <!-- javascript -->
            <script src="line900.js"></script>
            <script src="line901.js"></script>
            
            <!-- SLIDER -->
            <script src="line904.js"></script>
            <script src="line905.js"></script>
            <!-- Icons -->
            <script src="line907.js"></script>
            <script src="https://gatewaycapitalltd.com/temp/js/bundle.js"></script>
            
            <script src="line910.js"></script>
            <script src="line911.js"></script>
